...
(async () => {
  ...
  await page.goto(process.env.HOME_URL, { waitUntil: "networkidle0" });
  await page.type("input#username.pf-c-form-control", process.env.APO, {
    delay: 200,
  }); //username input field
  await page.type("input#password.pf-c-form-control", process.env.PASS, {
    delay: 200,
  ...
  await page.goto(process.env.OBSERVATION_URL);
  await page.waitForSelector("div.form-group.row");
  await page.click(
    "body > div.container-fluid > main > form > div:nth-child(2) > div > span.k-widget.k-dropdown"
  );
  ...
  await page.click(
    "body > div.container-fluid > main > form > div:nth-child(18) > div.col.offset-md-2 > button"
  );
  await new Promise((r) => setTimeout(r, 200));
  await page.click(
    "body > div.k-widget.k-window.k-dialog > div.k-dialog-buttongroup.k-dialog-button-layout-stretched > button.k-button.k-primary"
  );
